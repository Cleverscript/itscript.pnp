...
$arMainPropsTab = [
	"DIV" => "edit1",
	"TAB" => Loc::getMessage("ITSCRIPT_PUSH_AND_PULL_MAIN_TAB_SETTINGS"),
	"TITLE" => Loc::getMessage("ITSCRIPT_PUSH_AND_PULL_MAIN_TAB_SETTINGS_TITLE"),
	"OPTIONS" => [

		["ITSCRIPT_PUSH_AND_PULL_CONFIG_DEBUG", Loc::getMessage("T_ITSCRIPT_PUSH_AND_PULL_CONFIG_DEBUG"),
			$defaultOptions["ITSCRIPT_PUSH_AND_PULL_CONFIG_DEBUG"],
			["checkbox"]
        ],
